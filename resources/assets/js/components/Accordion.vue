<template>
    <div>
        <div class="flex m-3" v-if="success">
            <p class="mr-3">All set and saved. Want to try again?</p>
            <a class="underline text-green-darker cursor-pointer" @click="reset">Sure</a>
        </div>
        <div class="container p-10 bg-white rounded-lg" v-if="!success">
